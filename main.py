...
from fashion_purchase_router import router as purchase_router
from recommendation_router_with_memory import router as recm_router
...
app.include_router(recm_router)
@app.get("/health")
def health():
    return {"status": "ok"}
